...
if(auth == null || !auth.isAdmin()){
 ...
 int id = 0;
    ...
    while (rs.next()) {
        categories.add(new Category(rs.getInt("IDKategorija"), rs.getString("Naziv")));
    }
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="billDetailsAdmin">Prošle narudžbe</a>
                    </li>
                    <li class="nav-item">
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="edit-category" method="post">
                            <h3 class="text-center text-info">UREDI KATEGORIJU</h3>
                            <div class="form-group">
                                <label for="username" class="text-info">ID KATEGORIJA</label><br>
                                <input type="text" name="id" id="id" class="form-control" value="<%=category.getId()%>">
                            </div>
                            <div class="form-group">
                                <label for="username" class="text-info">NAZIV</label><br>
                                <input type="text" name="category_name" id="category_name" class="form-control" value="<%=category.getCategoryName()%>">
                            </div>
                            <div class="form-group">
